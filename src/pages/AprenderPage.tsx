...
import type { Book, Podcast, Course, LearningStatus } from '@/types/learning'
...
export function AprenderPage() {
  ...
  const [editingItem, setEditingItem] = useState<Book | Podcast | Course | null>(null)
  ...
  const handleEditItem = (item: Book | Podcast | Course) => {
    setEditingItem(item)
  ...
  const renderItemCard = (item: Book | Podcast | Course) => {
