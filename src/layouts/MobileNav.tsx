      ...
      {MOBILE_NAV_ITEMS.map((item) => {
        ...
        return (
          ...
          >
            ...
            <div className={`relative z-10 ${isActive ? 'text-blue-400' : 'text-white/35'}`}>
            ...
            <span className={`text-[10px] font-medium relative z-10 ${isActive ? 'text-blue-300 font-semibold' : 'text-white/25'}`}>
              {item.label}
            </span>
          </NavLink>
        )
